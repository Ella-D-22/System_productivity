...
import { OfficeAccountLookupComponent } from '../office-account-lookup/office-account-lookup.component';
  ...
  onChange(event:any){
    ...
    this.customer_type = event.target.value;
        ...
        onSubmit(){
          ...
          if(this.formData.valid){
            ...
            if(this.function_type == "A-Add"){
              this.router.navigate(['system/office-account/data/view'], { state: this.formData.value
                   });
           }
           else{
            this.router.navigate(['system/office-account/data/view'], {
        ...
        accountLookup(): void {
          ...
          const cdialogRef = this.dialog.open(OfficeAccountLookupComponent,dconfig);
