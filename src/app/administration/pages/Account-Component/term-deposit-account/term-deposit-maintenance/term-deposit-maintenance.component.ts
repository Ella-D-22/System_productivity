...
export class TermDepositAccountMaintenanceComponent implements OnInit {
  ...
  onChange(event:any){
    ...
    this.customer_type = event.target.value;
        ...
        onSubmit(){
          ...
          if(this.formData.valid){
            ...
            if(this.function_type == "A-Add"){
              this.router.navigate(['system/term-deposit-account/data/view'], { state: this.formData.value
                   });
           }
           else{
            this.router.navigate(['system/term-deposit-account/data/view'], {
        ...
        accountLookup(): void {
          ...
          const cdialogRef = this.dialog.open(TermDepositLookupComponent,dconfig);
