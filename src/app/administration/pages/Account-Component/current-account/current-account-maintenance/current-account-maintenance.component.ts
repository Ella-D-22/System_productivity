...
import { CurrentAccountLookupComponent } from '../current-account-lookup/current-account-lookup.component';

@Component({
  selector: 'app-current-account-maintenance',
  templateUrl: './current-account-maintenance.component.html',
  styleUrls: ['./current-account-maintenance.component.scss']
})
export class CurrentAccountMaintenanceComponent implements OnInit {
  ...
  onChange(event:any){
    ...
    this.customer_type = event.target.value;
        ...
        onSubmit(){
          ...
          if(this.formData.valid){
            ...
            if(this.function_type == "A-Add"){
              this.router.navigate(['system/current-account/data/view'], { state: this.formData.value
                   });
           }
           else{
        ...
        accountLookup(): void {
          ...
          const cdialogRef = this.dialog.open(CurrentAccountLookupComponent,dconfig);
