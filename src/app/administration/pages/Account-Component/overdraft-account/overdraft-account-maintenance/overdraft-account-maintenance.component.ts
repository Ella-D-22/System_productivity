...
import { OverdraftAccountLookupComponent } from '../overdraft-account-lookup/overdraft-account-lookup.component';

@Component({
  selector: 'app-overdraft-account-maintenance',
  templateUrl: './overdraft-account-maintenance.component.html',
  styleUrls: ['./overdraft-account-maintenance.component.scss']
})
export class OverdraftAccountMaintenanceComponent implements OnInit {
  ...
  onChange(event:any){
    ...
    this.customer_type = event.target.value;
        ...
        onSubmit(){
          ...
          if(this.formData.valid){
            ...
            if(this.function_type == "A-Add"){
              this.router.navigate(['system/overdraft-account/data/view'], { state: this.formData.value
                   });
           }
           else{
            this.router.navigate(['system/overdraft-account/data/view'], {
        ...
        accountLookup(): void {
          ...
          const cdialogRef = this.dialog.open(OverdraftAccountLookupComponent,dconfig);
