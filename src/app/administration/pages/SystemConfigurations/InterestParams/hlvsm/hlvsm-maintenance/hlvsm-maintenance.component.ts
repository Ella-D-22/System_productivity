...
@Component({
  selector: 'app-hlvsm-maintenance',
  templateUrl: './hlvsm-maintenance.component.html',
  styleUrls: ['./hlvsm-maintenance.component.scss']
})
export class HlvsmMaintenanceComponent implements OnInit {
  ...
  onSubmit(){
    ...
    if(this.formData.valid){
      ...
      if(this.function_type == "A-Add"){
        ...
        this.subscription = this.hlvsmAPI.checkHlvsm(this.params).subscribe(res=>{
          // not available else proceed
        this.hlvsmAPI.changeMessage(this.formData.value)
        this.ngZone.run(() => this.router.navigateByUrl('system/configurations/interest/hlvsm/data/view'));
        }, err=>{
