...
export class EventTypeService {
  ...
  headers = new HttpHeaders().set('Content-Type', 'application/json');
    // API endpoint
  baseURL = `${environment.productAPI}/api/v1/parameters/configurations/event_type`;
  ...
  // /find/by/code/{code}
  // get BYCode
  getEventTypeCode(code: any): Observable<any> {
  ...
  // Get by id
  getEventTypeId(id: any): Observable<any> {
  ...
  updateEventType(id: string | null, data: any): Observable<any> {
