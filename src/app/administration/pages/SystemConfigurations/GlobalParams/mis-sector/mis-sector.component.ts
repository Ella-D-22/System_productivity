    ...
    if (this.formData.valid) {
      if (this.function_type == "A-Add") {
        this.subscription = this.SectorAPi.createMisSector(this.formData.value).subscribe(
          res => {
            this.results = res;
            this._snackbar.open("MIS sector record added successfully!", "OK", {
              horizontalPosition: this.horizontalPosition,
              verticalPosition: this.verticalPosition,
              duration: 3000,
        ...
        this.subscription = this.SectorAPi.updateMissector(this.formData.value).subscribe(
          res => {
            this.results = res
            this._snackbar.open("MIS sector record  modified successfully", "X", {
              horizontalPosition: this.horizontalPosition,
              verticalPosition: this.verticalPosition,
              duration: 3000,
              panelClass: ['green-snackbar', 'login-snackbar']
        ...
        this.subscription = this.SectorAPi.updateMissector(this.formData.value).subscribe(
          res => {
            this.results = res
            this._snackbar.open("MIS sector record Deleted Successfully", "OK", {
              horizontalPosition: this.horizontalPosition,
              verticalPosition: this.verticalPosition,
              duration: 3000,
              panelClass: ['green-snackbar', 'login-snackbar']
      ...
      this._snackbar.open("MIS sector form data invalid", "TRY AGAIN", {
        horizontalPosition: this.horizontalPosition,
        verticalPosition: this.verticalPosition,
        duration: 3000,
        panelClass: ['red-snackbar', 'login-snackbar']
